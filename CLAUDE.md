...
This project is indexed by GitNexus as **TOCFL-Study** (1702 symbols, 2382 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/TOCFL-Study/context` | Codebase overview, check index freshness |
| `gitnexus://repo/TOCFL-Study/clusters` | All functional areas |
| `gitnexus://repo/TOCFL-Study/processes` | All execution flows |
| `gitnexus://repo/TOCFL-Study/process/{name}` | Step-by-step execution trace |
