...
export const T = {
  ...
  cat_badge:          { vi: '🧠 CAT',                      zh: '🧠 適性測驗',                   en: '🧠 CAT'                          },
  cat_title:          { vi: 'Kiểm Tra Thích Nghi',         zh: '電腦適性測驗',                   en: 'Adaptive Testing'                },
  cat_subtitle:       { vi: 'Đề thi tự điều chỉnh theo năng lực thời gian thực', zh: '根據即時能力自動調整題目難度', en: 'Real-time adaptive difficulty based on your ability' },
  cat_mode_reading:   { vi: '📖 Đọc Hiểu',                 zh: '📖 閱讀理解',                   en: '📖 Reading'                      },
  cat_mode_listening: { vi: '🎧 Nghe Hiểu',                zh: '🎧 聽力理解',                   en: '🎧 Listening'                    },
  cat_mode_r_short:   { vi: 'Đọc Hiểu',                   zh: '閱讀理解',                       en: 'Reading'                         },
  cat_mode_l_short:   { vi: 'Nghe Hiểu',                  zh: '聽力理解',                       en: 'Listening'                       },
  cat_questions_unit: { vi: 'câu hỏi',                    zh: '道題目',                         en: 'questions'                       },
  cat_how1:           { vi: '35 câu hỏi, mỗi câu một màn hình', zh: '共35題，每題單獨一頁',       en: '35 questions, one per screen'    },
  cat_how2:           { vi: 'Câu tiếp theo chọn dựa trên độ khó phù hợp với θ hiện tại (IRT Rasch)', zh: '根據當前能力θ選擇最適難度題目（IRT Rasch模型）', en: 'Next question matched to your current θ (IRT Rasch model)' },
  cat_how3_read:      { vi: 'Thời gian phản hồi ảnh hưởng cách tính điểm — nhanh & đúng = tốt hơn', zh: '答題時間影響評分——快速答對得分更高', en: 'Response time affects scoring — fast & correct = bigger boost' },
  cat_how3_listen:    { vi: 'Audio tự động phát · Thời gian tính từ khi câu hỏi hiện ra', zh: '音頻自動播放 · 計時從題目出現開始', en: 'Audio auto-plays · Timer starts when question appears' },
  cat_how4:           { vi: 'Kết quả: Điểm thang TOCFL 2025 (200–800) + cấp độ A1→C2', zh: '成績：TOCFL 2025分數（200–800）+ 等級A1→C2', en: 'Result: TOCFL 2025 score (200–800) + level A1→C2' },
  cat_how5:           { vi: 'Không được quay lại câu trước', zh: '不可返回上一題',                en: 'Cannot go back to previous questions' },
  cat_pool_label:     { vi: 'Ngân hàng',                  zh: '題庫',                           en: 'Question Bank'                   },
  cat_pool_unit:      { vi: 'câu',                        zh: '題',                             en: 'qs'                              },
  cat_test_label:     { vi: 'Đề thi',                     zh: '測驗',                           en: 'Test'                            },
  cat_per_test:       { vi: 'câu/test',                   zh: '題/次',                          en: 'qs/test'                         },
  cat_scale_label:    { vi: 'Thang điểm',                 zh: '分數範圍',                        en: 'Score Range'                     },
  cat_scale_unit:     { vi: 'TOCFL 2025',                 zh: 'TOCFL 2025',                     en: 'TOCFL 2025'                      },
  cat_start_btn:      { vi: 'Bắt đầu CAT',                zh: '開始適性測驗',                   en: 'Start CAT'                       },
  cat_score_table:    { vi: 'Thang điểm TOCFL 2025',      zh: 'TOCFL 2025 分數表',              en: 'TOCFL 2025 Score Table'          },
  cat_q_label:        { vi: 'Câu',                        zh: '第',                             en: 'Q'                               },
  cat_difficulty:     { vi: 'Độ khó',                     zh: '難度',                           en: 'Difficulty'                      },
  cat_confirm:        { vi: 'Xác nhận →',                 zh: '確認 →',                         en: 'Confirm →'                       },
  cat_audio_playing:  { vi: '🎧 Đang phát…',              zh: '🎧 播放中…',                     en: '🎧 Playing…'                     },
  cat_audio_paused:   { vi: '🎧 Tạm dừng · Nhấn ▶ để tiếp tục', zh: '🎧 已暫停 · 按▶繼續',   en: '🎧 Paused · Press ▶ to resume'   },
  cat_audio_start:    { vi: '🎧 Nhấn ▶ để nghe',          zh: '🎧 按▶開始聆聽',                 en: '🎧 Press ▶ to play'              },
  cat_audio_replay:   { vi: 'Nghe lại',                   zh: '重聽',                           en: 'Replay'                          },
  cat_see_image:      { vi: '↑ Xem hình cho câu số',      zh: '↑ 請看第',                       en: '↑ See image for Q'               },
  cat_done_header:    { vi: '✓ Hoàn thành',               zh: '✓ 測驗完成',                     en: '✓ Completed'                     },
  cat_sentences:      { vi: 'câu',                        zh: '題',                             en: 'qs'                              },
  cat_score_reading:  { vi: 'Điểm Đọc Hiểu · TOCFL 2025', zh: '閱讀理解分數 · TOCFL 2025',     en: 'Reading Score · TOCFL 2025'      },
  cat_score_listen:   { vi: 'Điểm Nghe Hiểu · TOCFL 2025', zh: '聽力理解分數 · TOCFL 2025',    en: 'Listening Score · TOCFL 2025'    },
  cat_stat_correct:   { vi: 'Đúng/Tổng',                  zh: '答對/總題',                      en: 'Correct/Total'                   },
  cat_stat_pct:       { vi: 'Tỉ lệ đúng',                zh: '正確率',                         en: 'Accuracy'                        },
  cat_stat_avg:       { vi: 'TB/câu',                     zh: '平均/題',                        en: 'Avg/Q'                           },
  cat_stat_theta:     { vi: 'θ cuối',                     zh: '最終θ值',                        en: 'Final θ'                         },
  cat_theta_journey:  { vi: 'Hành trình θ (năng lực ước tính)', zh: 'θ 變化歷程（能力估算）',   en: 'θ Journey (ability estimate)'    },
  cat_by_section:     { vi: 'Theo nhóm câu hỏi',          zh: '各題組成績',                     en: 'By Section'                      },
  cat_sec_12:         { vi: 'Phần 1–2',                   zh: '第1–2部分',                      en: 'Part 1–2'                        },
  cat_sec_3:          { vi: 'Phần 3',                     zh: '第3部分',                        en: 'Part 3'                          },
  cat_sec_4:          { vi: 'Phần 4',                     zh: '第4部分',                        en: 'Part 4'                          },
  cat_sec_5:          { vi: 'Phần 5',                     zh: '第5部分',                        en: 'Part 5'                          },
  cat_redo:           { vi: 'Làm lại',                    zh: '再做一次',                        en: 'Redo'                            },
  cat_home:           { vi: 'Trang chủ',                  zh: '首頁',                           en: 'Home'                            },
} as const;
